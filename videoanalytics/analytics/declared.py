...
from videoanalytics.models import Coords, SideValue, Side, EvalTree
...
conditions.append(Condition(
    Event(crosses, object_kinds[0], {'tool': tools[0], 'sides': EvalTree(
        left=Side(SideValue('left')),
        op_or_val=op_or,
        right=Side(SideValue('top'))),
                                     }),
    [Action(increment, {'counter': tools[1], }),
