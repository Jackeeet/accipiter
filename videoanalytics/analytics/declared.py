...
conditions.append(Condition(
    Event(crosses, object_kinds[1], {'segment': tools[1], }),
    [declarations[0], Action(alert, {'message': 'еще одно сообщение', }), ]
))
declarations[2] = Event(crosses, object_kinds[0], {'segment': tools[1], })
declarations[3] = Event(crosses, object_kinds[0], {'segment': tools[2], })
...
conditions.append(Condition(
    EventChain(
        left=Event(crosses, object_kinds[1], {'segment': tools[2], }),
        val=op_and,
        right=declarations[3]
    ),
    [declarations[1], ]
...
conditions.append(Condition(
    declarations[5],
    [Action(alert, {'message': '1000 пересечений линии', }), Action(save, {'message': '1000 пересечений линии', }),
     Action(reset, {'counter': tools[4], }), ]
))
