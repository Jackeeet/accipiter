...
object_kinds = ['птица', 'автомобиль', ]
tools: dict[int, Tool | tuple[int, int]] = dict()

tools[0] = Coords(200, 100)
tools[1] = Coords(300, 100)
tools[2] = Coords(300, 200)
tools[3] = Coords(200, 200)
...
conditions.append(Condition(
    Event(is_inside, object_kinds[0], {'area': tools[8], 'period': 3, }),
